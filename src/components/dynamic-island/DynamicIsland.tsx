...
const user = { email: "ho@williammartinsson.com" };
...
export function DynamicIsland() {
  ...
  return (
    <div className="absolute translate-center-x">
      <div className="gap-6 h-[44px] relative w-fit bg-black px-3  shadow-menu rounded-full flex items-center justify-center select-none overflow-hidden whitespace-nowrap ">
        <motion.div
...
function Logo({
  ...
  return (
    <div
      ...
      className={`bg-[orange] h-[var(--size)] w-[var(--size)] rounded-full ${className}`}
      style={
        {
          "--size": `${size}px`,
