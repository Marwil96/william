        ...
        return (
            <div className="CaseContainer">
                ...
                <div className='CaseContainer-content'>
                    ...
                    <h3> Discover </h3>
                    <TextBlock label='Market research' text='We started our entire process by doing market research to investigate if there were any other similar solutions on the market today. We noticed that many of Akademiska Hus competitors had applications where their customers could easily report property faults.' />
                    ...
                    <TextBlock label='Interviewing Result' text={ 
                        ...
                        <br/>- The reporting system on the Akademiska Hus website is difficult and annoying to use.
                    ...
                    <TextBlock label='Users' text='We discussed which users we would prioritize to target this new service to and who would need it. We found that we would primarily need to solve the communication between Akademiska Hus – Customer/Tenants – Users/the people who use Akademiska Hus properties.' />
                    ...
                    <TextBlock label='Solution' text={
                        <span>
                            ...
                            <br/>- Sending a picture with the faults form.
                    ...
                    <div className='CaseContainer-TextWithImage'> 
                        <TextBlock label='Interface' text='The application was created with 32px margins and 4 column layout. We used google material design 2.0 because we felt that it was a waste of time to create new elements.' />
