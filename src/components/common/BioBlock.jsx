...
const BioBlock = (props) => {
    return (
        <div className="BioBlock">
            ...
            <br/><br/>Now when you got a good sense of my origin we should probably continue. After spending my childhood in Skara I moved to <span data-bio-target='https://www.pro.se/Global/PRO%20riksorganisationen/PRO%2075/11699423-fontan-poseidon-i-goteborg.jpg?preset=ArticleMainImage'> Gothenburg </span> to start my education in Digital Design at <span data-bio-target='./assets/images/yrgo.jpg'>YRGO</span>. During my time in Gothenburg i learned about design on the days and development by the nights. After a while I started to do freelance work for organistations such as Hallands Region & Devolve digital. When my time at YRGO started to run its course I started working for <span data-bio-target='https://d2zr9w65gdacs9.cloudfront.net/19631/momkai-homerun-photo-651520968169full-width.jpg'>Momkai</span> in Amsterdam where I have worked for clients such as <span data-bio-target='https://www.economist.com/sites/default/files/20171028_BLP506.jpg'>KNVB </span> and HVA.
            <br/><br/>Facts.
