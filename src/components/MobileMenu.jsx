...
const MobileMenu = ({menuActive, closeMenu}) => {
  return (
    <MobileMenuWrapper className={menuActive ? 'is-active' : ''}>
      ...
      <LinkContainer>
        <MobileLink><Link to='/'>Home</Link></MobileLink>
        <MobileLink><Link to='/work'>Work</Link></MobileLink>
        <MobileLink><Link to='/services'>Services</Link></MobileLink>
        <MobileLink><Link to='/contact'>Contact</Link></MobileLink>
      </LinkContainer>
    </MobileMenuWrapper>
  )
}
