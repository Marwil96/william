...
const subtitle =
  "We were tasked to create an alumni page for Amsterdam University of Applied Sciences design students, where each student can have their page showing off their expertise, personality and skills.";
...
const MasterDigitalDesign = () => {
  return (
    <Layout
      ...
      desc={subtitle}
      project={true}
      framerKey="master-digital-design"
    >
      <ProjectComponent
        title="Master Digital Design"
        metadata={metadata}
      ...
      >
        ...
        <p>
          ...
          students should be able to have their profile where they could have a
          small text about themself, portrait image, a quote, video, contact
          information, and links to the articles the students have authored.
          <br /> <br />
          All the students needed to exist on a collection page where you could
          filter all the students based on their different skills. Also on top
          of the collection page, the university needed to be able to highlight
