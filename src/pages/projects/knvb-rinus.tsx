...
const metadata = [{label: 'Client', value: 'KNVB'}, {label: 'Role', value: 'Intern Frontend developer'}, {label: 'Team', value: 'Momkai'}];
const subtitle = 'We were tasked to build the new version of KNVBs Rinus, a training platform for football teams. Where they can plan their exercises and get inspiration and advice from other football coaches.'
