...
const metadata = [
  ...
  { label: "Tech", value: "Gatsby, Prismic, SASS, GraphQL." },
];
const subtitle =
  "Knodd is a medicare startup from Gothenburg, they allow you to consult a qualified health professional about your child via your smartphone or tablet. ";

const Knodd = () => {
  return (
    <Layout title="Knodd" desc={subtitle} project={true} framerKey="knodd">
      <ProjectComponent
        title="Knodd"
        metadata={metadata}
        // subtitle={subtitle}
      ...
      >
        ...
        {/* <p>
          ...
          entirely new part of the website with articles about different child
          diseases.
        </p>
        <h5>Thoughts about the tech stack.</h5>
        <p>
          Gatsby has quickly grown to become a favorite of mine for building
          static websites. It makes it super easy to build superb performing
