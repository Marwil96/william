  ...
  return (
    <PageWrapper>
      ...
      <section className="Contact">
        <h1 className={`Contact__highfive ${aniState ? 'Contact__highfive-active' : ''}`}>*SMACK* HIGHFIVE</h1>
        <div className="Contact__container">
          <div className="Contact__col-left">
            <h1 className="Contact__title">Get in touch!</h1>
            <p className="Contact__text">
              Are you unsure of your digital strategy, do you need help figuring
              out what kind of technical solution you need, or are you just
              curious to know more about me?
              <br /> <br />
              Say hi at <a href='mailto: william@agenly.se'className="Contact__link">william@agenly.com</a> or
              (if urgent!) text <a href='tel:+46768023804' className="Contact__link">+46 768023804</a>{" "}
